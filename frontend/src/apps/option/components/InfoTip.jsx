...
export default function InfoTip({ entryKey, reading, className = "" }) {
  ...
  const [pos, setPos] = useState(null); // { left, top, width, placement }
  ...
  const place = useCallback(() => {
    ...
    // Horizontal: center on the icon, then clamp into the viewport.
        ...
        createPortal(
          <>
            ...
            <div
              ...
              className="z-[80] bg-card border border-border rounded-xl p-3 shadow-2xl text-left cursor-default"
            >
